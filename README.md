...
this command will build file named _simulation_ ,and to open this file write in terminal 

``` ./simulation angle T1 T2 ```

but you replace angle,T1 and T2  parameters by any valid values,then the window will appear and you cane see the simultion,and to repeat the excitation-relations proccess just press on (__a__) button in the keyboard this will give RF pulse witn the same angle.
