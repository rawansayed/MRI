...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def freq(self):
        self.gamma = 4.258
        self.larmorfreq = self.gamma * self.add
        print(self.larmorfreq )
        self.ui.widget_3.showGrid(x=True, y=True)
        self.ui.widget_3.addLegend()
        self.ui.widget_3.setXRange(0, 150, padding=0)
        self.ui.widget_3.setLabel('left', 'field', color='white', size=30)
        self.ui.widget_3.setLabel('bottom', 'freq', color='white', size=30)
        self.pen = pg.mkPen(color=(204, 0, 204))
        self.ui.widget_3.plot(self.larmorfreq, self.add, pen=self.pen)
